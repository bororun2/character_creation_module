...
def special(char_name: str, char_class: str) -> str:
    """Фунцуия выполнения специального умения героя."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Функция выбора персонада с характеристиками персонажа."""
    approve_choice: str = ''
    char_class: str = ''
    while approve_choice != 'y':
        ...
        approve_choice = input('Нажми (Y), чтобы подтвердить выбор, или любую '
                               'другую кнопку, чтобы выбрать другую персону: ',
                               ).lower()
    return char_class
